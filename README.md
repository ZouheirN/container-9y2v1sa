...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9y2v1sa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9y2v1sa.containers.anotherwebservice.com/
...
```
git clone git@github.com:ZouheirN/container-9y2v1sa.git
cd container-9y2v1sa
```
...
```
docker attach container-9y2v1sa
```
